...
export class CustomCardInputComponent
  extends BasicPageComponent
  implements OnInit
{
  ...
  watchValue() {
    if (
      !(
        this.btnCheck.annualIncome === '' ||
        this.btnCheck.financialAssets === '' ||
        this.btnCheck.investmentPolicy === '' ||
        this.btnCheck.InvestmentExperience_1 === '' ||
        this.btnCheck.InvestmentExperience_2 === '' ||
        this.btnCheck.InvestmentExperience_3 === '' ||
        this.btnCheck.InvestmentExperience_4 === '' ||
        this.btnCheck.InvestmentExperience_5 === '' ||
        this.btnCheck.InvestmentExperience_6 === '' ||
        this.btnCheck.InvestmentExperience_7 === '' ||
        this.btnCheck.InvestmentExperience_8 === '' ||
        this.btnCheck.InvestmentExperience_9 === ''
      )
    ) {
      this.isShow = true;
    } else {
  ...
  ngOnInit(): void {
    ...
    this.btnCheck = this.custService.radioValue;
    this.watchValue();
